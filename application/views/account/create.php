                ...
                <ul class="form-list">
                    <li class="fields">
                        <div class="customer-name">
                            <div class="input-box">
                                ...
                                <input type="text" class="required-entry input-text" title="Voornaam" value=""
                                       name="firstname" id="firstname">
                            </div>
                            <div class="input-box">
                                <label for="affix">Tussenvoegsel</label>
                                <input type="text" class="input-text" title="Tussenvoegsel" value="" name="affix"
                                       id="affix">
                            </div>
                            <div class="input-box">
                                <label for="lastname">Achternaam<em>*</em></label>
                                <input type="text" class="required-entry input-text" title="Achternaam" value=""
                    ...
                    <li>
                        <div class="input-box">
                            ...
                            <input type="text" class="input-text required-entry" title="Postcode" value="" id="zip_code"
                                   name="zip_code">
                        </div>
                        <div class="input-box">
                            <label class="required" for="house_number">Huisnummer<em>*</em></label>
                            <input type="text" class="input-text required-entry" title="Huisnummer" value=""
                    ...
                    <li>
                        <div class="input-box">
                            ...
                            <input type="email" class="input-text validate-email required-entry" title="Email Adres"
                                   value="" id="email_address" name="email">
                        </div>
                        <div class="clear"></div>
                    </li>
                </ul>
                    ...
                    <li class="fields">
                        <div class="customer-name">
                            <div class="input-box">
                                ...
                                <input type="password" class="required-entry input-text" title="Password" value=""
