    ...
    <div class="content-container container">
        <div class="col-left">
            <div class="block community-block">
                ...
                <div style="overflow:hidden;height:340px;width:220px;">
                    <div id="gmap_canvas" style="height:340px;width:220px;"></div>
                ...
                <script type="text/javascript"> function init_map() {
                        var myOptions = {
                            zoom: 15,
                            center: new google.maps.LatLng(51.9276297, 4.478093100000024),
                            mapTypeId: google.maps.MapTypeId.ROADMAP
                        };
                        map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);
                        marker = new google.maps.Marker({
                            map: map,
                            position: new google.maps.LatLng(51.9276297, 4.478093100000024)
                        });
                        infowindow = new google.maps.InfoWindow({content: "<b>Mo's webshop</b><br/>Heer bokelweg 255<br/>3032AD Rotterdam"});
